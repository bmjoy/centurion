...
int test_it( const char file_in[], const char file_out[] )
{
    ...
    //         const c_settings item( file_in, &lmx_error );
    c_settings item( file_in, &lmx_error, &lmx_error_detail );      // lmx_error_detail is an optional argument
    ...
    else
    {
        ...
        // See the documentation generated in C:\Users\utente\Documents\github rattlesmake\centurion\centurion-utils\lmx\output\settings.html
        // for help creating code.
        // (Try file:C:\Users\utente\Documents\github%20rattlesmake\centurion\centurion-utils\lmx\output\settings.html)
