...
#ifndef TRANSLATION_TABLE_HXX
#define TRANSLATION_TABLE_HXX
...
class translationTable: public ::xml_schema::type
{
  public:
  // entry
  //
  ...
  // Constructors.
  //
  translationTable (const language_type&);
...
class entry: public ::xml_schema::type
{
  ...
  // stringName
  //
  typedef ::xml_schema::string stringName_type;
  typedef ::xsd::cxx::tree::traits< stringName_type, char > stringName_traits;

  const stringName_type&
  stringName () const;
  ...
  void
  stringName (::std::auto_ptr< stringName_type > p);
  ...
  protected:
  ::xsd::cxx::tree::one< stringName_type > stringName_;
...
translationTable_ (const ::std::string& uri,
                   ::xml_schema::flags f = 0,
...
::std::auto_ptr< ::translationTable >
translationTable_ (::xercesc::InputSource& is,
                   ::xml_schema::flags f = 0,
                   const ::xml_schema::properties& p = ::xml_schema::properties ());
...
::std::auto_ptr< ::translationTable >
translationTable_ (const ::xercesc::DOMDocument& d,
                   ::xml_schema::flags f = 0,
                   const ::xml_schema::properties& p = ::xml_schema::properties ());
