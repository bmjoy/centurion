 ...
 **********************************************************************************************/
#ifndef _ParamsLib_ParamsLib_CCamera_h
#define _ParamsLib_ParamsLib_CCamera_h
...
namespace ParamsLib
{
	 ...
	 * CCamera
	 *  
	 * This class wraps the element camera in the schema
	 */
	class ParamsLib_DLL CCamera : public CInstanceMonitor
...
// ##HAND_CODED_BLOCK_END ID="Additional Base Classes"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
	{
	public:
		static ParamsLib::CCameraPtr CreateInstance(LPCTSTR lpctElementName=_T("camera"));

	protected:
		CCamera(LPCTSTR lpctElementName=_T("camera"));
		virtual ~CCamera();
	...
	public:
		...
		virtual ParamsLib::CCameraPtr Clone() const;
