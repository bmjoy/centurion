...
public: 
	...
	/// <summary>
	/// This method resets all click id
	/// </summary>
	static void ResetAllClickIds();
...
public:
	...
	/// </summary>
	static void ResetClickIds(void);
	
	/// <summary>
	/// This method returns the leftclick id;
	/// </summary>
	/// <returns></returns>
	static unsigned int GetLeftClickId(void);
	
	/// <summary>
	/// This method returns the rightclick id;
	/// </summary>
	/// <returns></returns>
	static unsigned int GetRightClickId(void);
	
	/// <summary>
	/// This method updates the leftclick and rightclick ids
	/// </summary>
	static void UpdateClickIds(void);
...
private:
	...
	static unsigned int rightClickId_UI;
...
public:
	...
	~PickingObject(void);
private:
	static unsigned int pickingID_Obj;
	static unsigned int rightClickID_Obj;
	static unsigned int leftClickID_Obj;
