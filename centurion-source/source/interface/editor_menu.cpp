...
namespace editor {
    ...
    void EditorMenu::create() {
        ...
        for (int i = 0; i < titles.size(); i++) {
            ...
            titles[s].titleText.create_static(titles[s].title, "tahoma_15px", titles[s].titlePosition.x + 0.5f * titles[s].titleWidth, titles[s].titlePosition.y + 0.5f * titles[s].titleHeight, "center", "middle", glm::vec4(255.f));
            ...
            for (int j = 0; j < titles[s].options.size(); j++) {
                ...
                tempText.create_static(titles[s].options[j], "tahoma_15px", titles[s].optionsPosition[j].x + 0.5f * titles[s].optionsWidth - titles[s].optionsOffsetX, titles[s].optionsPosition[j].y + 0.5f * titles[s].optionsHeight, "left", "middle", glm::vec4(255.f));
