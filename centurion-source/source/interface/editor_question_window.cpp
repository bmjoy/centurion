...
namespace editor {
	...
	void QuestionWindow::create() {
		...
		PickingUI::AddValueToPickingList(PickingUI::GetLastPickingID() + 1, "QuestionWindow_Yes");

		buttons[1] = gui::Image("newmapwindow_buttonright");
		buttons[1].create("top-left", startX, startY, 0, 0, PickingUI::ObtainPickingID());
		PickingUI::AddValueToPickingList(PickingUI::GetLastPickingID() + 1, "QuestionWindow_No");
