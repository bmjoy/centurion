...
void myWindow::init() {
	...
	if (!getBoolean("full-screen")) MainWindow = glfwCreateWindow((int)getParam("window-width"), (int)getParam("window-height"), gameNameSTR.c_str(), nullptr, nullptr); // Windowed
	else MainWindow = glfwCreateWindow((int)getParam("window-width"), (int)getParam("window-height"), gameNameSTR.c_str(), glfwGetPrimaryMonitor(), nullptr); // full screen
