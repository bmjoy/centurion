...
public:
	...
	static void TryParseInteger(std::map<std::string, std::string> _map, std::string _name, int *variable_ptr);
	/// <summary>
	...
	/// <param name="_name">The indetifier of a property.</param>
	/// <param name="variable_ptr">A pointer used to retrieve a value.</param>
	static void TryParseFloat(std::map<std::string, std::string> _map, std::string _name, float *variable_ptr);
	/// <summary>
	...
	/// <param name="_name">The indetifier of a property.</param>
	/// <param name="variable_ptr">A pointer used to retrieve a value.</param>	
	static void TryParseString(std::map<std::string, std::string> _map, std::string _name, std::string *variable_ptr);
	/// <summary>
	...
	static ObjectXMLClassData* GetObjectData(std::string _class);
	/// <summary>
