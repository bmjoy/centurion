...
c_settings_(const ::std::string& uri,
	::xml_schema::flags f = 0,
...
::std::auto_ptr< ::c_settings >
c_settings_(::xercesc::InputSource& is,
	::xml_schema::flags f = 0,
	const ::xml_schema::properties& p = ::xml_schema::properties());
...
::std::auto_ptr< ::c_settings >
c_settings_(const ::xercesc::DOMDocument& d,
	::xml_schema::flags f = 0,
	const ::xml_schema::properties& p = ::xml_schema::properties());
...
void
c_settings_(::xercesc::XMLFormatTarget& ft,
	const ::c_settings& x,
	const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap(),
	const ::std::string& e = "UTF-8",
	::xml_schema::flags f = 0);
...
c_settings_(const ::c_settings& x,
	const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap(),
	::xml_schema::flags f = 0);
